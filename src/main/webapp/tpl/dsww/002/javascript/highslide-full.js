...
expandCursor : 'big.cur', // null disables
restoreCursor : 'small.cur', // null disables
...
/*modify*/		
	...
	$('body .product').css({'overflow':'hidden','height':'100%'});
	...
	document.body.addEventListener('DOMMouseScroll', this.preventDefault ,false);
...
/*modify*/
	...
	document.body.removeEventListener('DOMMouseScroll', this.preventDefault ,false);
