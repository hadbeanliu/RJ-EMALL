...
var Common = {
        ...
        Drag.prototype = {
            init: function(titleBar, dragDiv, Options) {
                ...
                titleBar.onmousedown = function(e) {
                    ...
                    version = Common.isIE();
                    switch(version){
                        case false: if(!ev.button == 0){
                                    return false;
                                };
                                break; 
                        case 7: if(!ev.button == 1){
                                    return false;
                                };
                                break; 
                        case 8: if(!ev.button == 1){
                                    return false;
                                };
                                break; 
                        
                        case 10: if(!ev.button == 0){
                                    return false;
                                };
                                break; 
                        case 11: if(!ev.button == 0){
                                    return false;
                                };
                                break; 
                        case 12: if(!ev.button == 0){
                                    return false;
                                };
                                break; 
                    }
            ...
            SetOpacity: function(dragDiv, n) {
                if (Common.isIE() == 7 || Common.isIE() == 8) {
        ...
        window.onload = function() {
            new Drag("drag_bar", "frame_im_win", { opacity: 100, keepOrigin: true }); //, area: { left: 50, right: 500, top: 100, bottom: 400}
        }