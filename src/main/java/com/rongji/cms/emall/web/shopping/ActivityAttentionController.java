...
@Controller
@RequestMapping("/buyer/myattention/activityattention")
public class ActivityAttentionController extends CrudAndPageByJsonController<MyAttention> {
...
//			metadata.addSearch(EmlMyAttention_.attentionType,"1");//商品
			metadata.addSearch(EmlMyAttention_.attentionType,"0");//为空
