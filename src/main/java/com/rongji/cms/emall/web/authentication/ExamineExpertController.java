 ...
 */
@Controller
@RequestMapping("admin/authentication/examine/expert")
public class ExamineExpertController extends CrudAndPageByJsonController<Examine> {
	...
	protected PageEntity<Examine> getPage(DatatablesMetadata metadata) {
		...
		metadata.addSearch(EmlExamine_.authentications.getName(), "2");
