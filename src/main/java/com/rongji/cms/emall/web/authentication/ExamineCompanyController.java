 ...
 */
@Controller
@RequestMapping("admin/authentication/examine/company")
public class ExamineCompanyController extends CrudAndPageByJsonController<Examine> {
	...
	protected PageEntity<Examine> getPage(DatatablesMetadata metadata) {
		...
		metadata.addSearch(EmlExamine_.authentications.getName(), "1");
