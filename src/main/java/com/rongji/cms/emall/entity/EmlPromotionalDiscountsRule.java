...
@Entity
@Table(name= TablePrefix.NAME + "PROMOTIONAL_DISCOUNTS_RULE")
public class EmlPromotionalDiscountsRule implements Sid {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmlPromotionalDiscountsRule other = (EmlPromotionalDiscountsRule) obj;
		if (id == null) {
			if (other.id != null)
				return false;
